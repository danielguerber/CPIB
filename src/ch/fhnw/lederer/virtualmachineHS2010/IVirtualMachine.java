...
public interface IVirtualMachine
{
    ...
    static class InternalError extends RuntimeException
    {
         ...
         * 
         */
        private static final long serialVersionUID = 1343013369080953570L;
    ...
    static class ExecutionError extends Exception
    {
         ...
         * 
         */
        private static final long serialVersionUID = 3221725022826316109L;
    ...
    static class HeapTooSmallError extends Exception {
         ...
         * 
         */
        private static final long serialVersionUID = -2534702832977677751L;}
    ...
    static class CodeTooSmallError extends Exception {
         ...
         * 
         */
        private static final long serialVersionUID = 5458965110748089054L;}
